...
$(".del").click(function(){
 ...
 if(text==1)
 {
 	 window.location.href = "meager/userOk?page="+${page.page};
 }else{
     alert("删除失败");
 }
  ...
  <body>
	...
	<c:forEach var="u" items="${users}">
		<tr>
			...
			<td>
			<button type="button" class="btn btn-primary edit" value="${u.id}">编辑</button>
			<button type="button" class="btn btn-danger del" value="${u.id}">删除</button>
			</td>
		</tr>
	</c:forEach>
	</tbody>
